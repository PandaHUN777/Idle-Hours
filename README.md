...
| `control`     | <img src="idle_hours/assets/previews/control.png" width="240" alt="control theme preview">         | white       | black | red    | Antonio              | Remedy's *Control* (custom layout, the Astral Plane: floating stone blocks + the Board's inverted pyramid, Hiss-red phrase blooming into the void, Bureau sign on a concrete plinth) |
