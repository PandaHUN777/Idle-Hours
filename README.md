...
| `vitrail`     | <img src="idle_hours/assets/previews/vitrail.png" width="240" alt="vitrail theme preview">         | jewel glass | black | violet | Liberation Serif + Uncial Antiqua | Gothic stained-glass window (custom layout, full palette) |
...
| `lieder`      | <img src="idle_hours/assets/previews/lieder.png" width="240" alt="lieder theme preview">           | cream/white | black | red    | Alegreya (literary serif) | Engraved art-song manuscript (custom layout, hour = time signature) |
| `izakaya`     | <img src="idle_hours/assets/previews/izakaya.png" width="240" alt="izakaya theme preview">         | black       | white | yellow | Quicksand + Yuji Boku | Neon alley at night (custom layout, glowing tube lettering) |
| `abyssal`     | <img src="idle_hours/assets/previews/abyssal.png" width="240" alt="abyssal theme preview">         | deep blue   | white | mint   | Lato (humanist sans) | Deep sea (custom layout, hour = depth on a sounding gauge) |
| `pride`       | <img src="idle_hours/assets/previews/pride.png" width="240" alt="pride theme preview">             | rainbow cloth | black | violet | Jost (geometric sans) | The Progress Pride flag, flying (custom layout, every ink at once) |
| `pulp`        | <img src="idle_hours/assets/previews/pulp.png" width="240" alt="pulp theme preview">               | yellow      | black | red    | Alfa Slab One (fat slab) | 1940s lurid paperback cover (custom layout, off-register plates) |
| `synoptic`    | <img src="idle_hours/assets/previews/synoptic.png" width="240" alt="synoptic theme preview">       | white       | black | red    | Space Mono (mono)    | Meteorological surface analysis (isobars + front symbols) |
| `vhs`         | <img src="idle_hours/assets/previews/vhs.png" width="240" alt="vhs theme preview">                 | black       | white | red/blue | Antonio (condensed sans) | Worn VHS tape under a camcorder OSD (custom layout, chroma bleed) |
| `bakelite`    | <img src="idle_hours/assets/previews/bakelite.png" width="240" alt="bakelite theme preview">       | brown CRT   | amber | white  | Jost + Space Mono    | Amber-phosphor CRT in a bakelite console (custom layout, glowing readout) |
| `cardcatalog` | <img src="idle_hours/assets/previews/cardcatalog.png" width="240" alt="cardcatalog theme preview"> | manila      | black | violet | Special Elite (typewriter) | Library catalogue card (custom layout, hour = date-due stamp) |
| `metro`       | <img src="idle_hours/assets/previews/metro.png" width="240" alt="metro theme preview">             | white       | black | red    | Jost + Space Mono    | Metropolitan transit diagram (custom layout, full-palette routes) |
| `intaglio`    | <img src="idle_hours/assets/previews/intaglio.png" width="240" alt="intaglio theme preview">       | white       | black | green  | Old Standard TT + Cinzel Decorative | Banknote engraving (custom layout, guilloché + hatched tone) |
| `nocturne`    | <img src="idle_hours/assets/previews/nocturne.png" width="240" alt="nocturne theme preview">       | black       | white | yellow | Cormorant Garamond   | Whistler night river (custom layout, flow-field brushwork) |
| `plaque`      | <img src="idle_hours/assets/previews/plaque.png" width="240" alt="plaque theme preview">           | green       | yellow | white | Cinzel Decorative    | Patinated bronze plaque (custom layout, relief-lit lettering) |
| `daguerreotype` | <img src="idle_hours/assets/previews/daguerreotype.png" width="240" alt="daguerreotype theme preview"> | white   | black | red    | Libre Caslon Text    | Cased 1850s photograph (custom layout, Atkinson-dithered plate) |
| `autochrome` | <img src="idle_hours/assets/previews/autochrome.png" width="240" alt="autochrome theme preview"> | white   | black | red    | Libre Caslon Text    | 1907 Lumiere colour plate (custom layout, first full six-ink dithered photograph) |
| `photo` | <img src="idle_hours/assets/previews/photo.png" width="240" alt="photo theme preview"> | white   | black | red    | Libre Caslon Text    | The operator's own picture via `--photo-path` (custom layout; conditioned, dithered, card placed by content — preview uses a bundled image as a stand-in) |
| `betweenus`   | <img src="idle_hours/assets/previews/betweenus.png" width="240" alt="betweenus theme preview">     | white/cream | black | red    | Fraunces + Inter      | Between Us app card, light (warm paper, soft-shadowed quote card, day-progress bar) |
| `betweenus_dark` | <img src="idle_hours/assets/previews/betweenus_dark.png" width="240" alt="betweenus_dark theme preview"> | black       | white | amber  | Fraunces + Inter      | Between Us app card, dark (warm charcoal paper, amber italic phrase) |
| `carcosa`     | <img src="idle_hours/assets/previews/carcosa.png" width="240" alt="carcosa theme preview">         | black       | white | yellow | Almendra             | The King in Yellow (tattered curtains, the Yellow Sign, twin suns over Lake Hali) |
| `control`     | <img src="idle_hours/assets/previews/control.png" width="240" alt="control theme preview">         | white       | black | red    | Oswald               | Remedy's *Control* (custom layout, the Astral Plane: floating stone blocks + the Board's inverted pyramid, Hiss-red phrase blooming into the void with resonance echoes, Bureau sign on a dithered concrete plinth) |
| `observation` | <img src="idle_hours/assets/previews/observation.png" width="240" alt="observation theme preview"> | black       | white | yellow | IBM Plex Mono        | No Code's *Observation* (custom layout, S.A.M.'s camera feed: a banded Saturn with its polar hexagon and rings, a blue-blooming hexagonal anomaly under a tracking reticle, the quote as an audio-log transcript; the hour is the camera number) |
| `trisolaris`  | <img src="idle_hours/assets/previews/trisolaris.png" width="240" alt="trisolaris theme preview">   | black       | white | yellow | Titillium Web        | *The Three-Body Problem* (custom layout: three suns and a planet from a live gravitational integration the clock advances, stable / chaotic eras, Red Coast dish) |
| `biomech`     | <img src="idle_hours/assets/previews/biomech.png" width="240" alt="biomech theme preview">         | black       | white | yellow | Spectral             | H. R. Giger + Zdzisław Beksiński (custom layout, a lit biomechanical wall of vertebrae, ribbed hoses and skulls framing a pointed arch onto a burning dusk and a ruined cathedral; the phrase is an ember, the hour the plate's Roman numeral) |
| `codex`       | <img src="idle_hours/assets/previews/codex.png" width="240" alt="codex theme preview">           | cream       | black | red    | Fondamento           | Codex Seraphinianus (custom layout: a chimerical rainbow-stemmed plant with fish-shaped leaves and an eye for a flower, columns of generated asemic script, the time as a base-21 page number in invented numerals) |
| `culture`     | <img src="idle_hours/assets/previews/culture.png" width="240" alt="culture theme preview">         | black       | white | yellow | Jura + Share Tech Mono | Iain M. Banks's Culture (custom layout, a Mind's signal: Excession-style ship-to-ship header, the quote as the signal body with the matched phrase in a green drone-aura bloom, a tilted Orbital beside it whose marked plate keeps the local time of day, and the phrase again in Marain-idiom glyphs) |
| `orbital`     | <img src="idle_hours/assets/previews/orbital.png" width="240" alt="orbital theme preview">         | sky / white | black | blue   | Jura                 | The Culture's Arch (custom layout, standing on an Orbital's plate: the far side of the ring rises from both horizons and each part of it is lit by its own local time, so the Arch is a 24-hour dial — dark overhead at noon, blazing overhead at midnight; the sky, sun and quote card follow the hour) |
| `furies` | <img src="idle_hours/assets/previews/furies.png" width="240" alt="furies theme preview"> | black       | white | orange | Libre Franklin       | Francis Bacon's *Three Studies for Figures at the Base of a Crucifixion* (1944) (custom layout: the triptych under glass in gilt frames — three smeared grey figures on flat cadmium orange, painted as separate layers and each separated against its own inks — with the quote as wall text beneath and the matched phrase in the painting's orange, a red smear dragged off it) |
| `bosch` | <img src="idle_hours/assets/previews/bosch.png" width="240" alt="bosch theme preview"> | white       | black | red    | Grenze Gotisch       | Hieronymus Bosch, *The Garden of Earthly Delights* (custom layout, the triptych open: Paradise / Garden / Hell, the quote lettered on a banderole with the matched phrase rubricated, the whole altarpiece crazed with craquelure) |
...
`marquee`, `tarot`, and `vinyl` are three more custom-render themes that follow the `astrarium` pattern — each dispatches out of `render()` into its own frame function and owns its composition top to bottom. **`marquee`** is a 1930s movie-palace facade: a black ground framed by an alternating yellow + red bulb-light border around the entire perimeter (with small white highlight pixels on each bulb so they read as lit glass), big chunky Bungee Shade book title at the top as the "feature title" (uppercased, auto-shrunk through 72→32pt and wrapping to two lines for long titles), a NOW SHOWING tagline above and ONE NIGHT ONLY below, the literary quote rendered in white Cardo Italic with a red matched-phrase accent as the feature copy, and a WRITTEN BY [AUTHOR] credit chrome at the bottom (yellow Antonio Bold label + white Cardo Italic name). The digital HH:MM is deliberately never surfaced — the matched-phrase red highlight in the body carries the time signal, the way every other quote-based literary clock does. **`tarot`** is a portrait major-arcana card laid on a cream-and-sepia foxed vellum reading cloth, with the interpretation in a cartouche beside it: doubled red+black rubricated border, rubricated corner lozenges, Roman-numeral hour at the head (Cinzel Decorative Black), a ruled illustration panel carrying an hour-mapped trump, and the trump's own name in Tyrian purple (R+B 1:1 dither) along the foot — numeral above, figure between, name below, the layout every historical trump uses. The name band held the matched phrase until that was read off the panel: the card came out titled TWENTY MINUTES PAST ONE under a picture of the Magician, overrunning its own rule and restating the time the reading beside it already carries. Its type size is fitted rather than fixed, so a long title like THE WHEEL OF FORTUNE is set smaller — what a real deck does — and the name is returned by the emblem painter itself, so it can never disagree with the figure it sits under. The trump itself is a **separated woodcut** from the public-domain Jean Dodal *Tarot de Marseille* (Lyon, 1701–1715): `scripts/ingest_tarot_plates.py` crops each scan's printed numeral and title bands, finds the line work with a local adaptive threshold, and separates the card to the theme's three inks once at build time, so the render just crops a tile from `assets/tarot_plates.png`. Hour maps to trump number, which puts the deck's own numbering on the card — Marseille numbers Justice VIII and La Force XI, where Rider-Waite swaps them. If no sprite sheet is present, twelve built-in line-work figures still draw every hour as a fallback. EB Garamond body in a clean cream cartouche knocked out of the cloth, centred attribution at its foot. **`vinyl`** is a turntable + LP back-cover, framed as a 1950s/60s **literary audiobook recording** — same chassis a music LP would have, but with the chrome text in the spoken-word register that real labels like Caedmon Records (Dylan Thomas, T. S. Eliot, Auden) and Spoken Arts pressed during the original audiobook-on-vinyl era. A black vinyl LP fills the left half (concentric sheen banding across the programme area + smooth dead-wax ring + heavier lead-in groove at the rim); a cased black-and-chrome tonearm pivots from the upper-right of the turntable with a visible counterweight + cartridge headshell + red stylus pin resting on the disk. **The minute drives the stylus radius, not an angle** — a record plays outside-in, so the arm creeps inward across the hour exactly as a real one does while a side plays, and its angle falls out of the geometry. The red label at the spindle carries an outer black ring border, a `· SPOKEN WORD ·` format mark, the matched-phrase passage title, an `IDLE HOURS / READ ALOUD` brand stack, a Space Mono catalog number like `IH-H2-30`, and a `© YYYY` year stamp. The right half is a cream-washed liner-notes panel: a small red `— READING —` heading at the top, the literary quote in Cormorant Garamond with a tangerine R+Y matched-phrase substitution, author/title attribution, and a bottom catalog bar reading `IDLE HOURS LITERARY RECORDINGS  ·  CAT NO. …  ·  © YYYY`. A `33 RPM` badge sits in the top-right corner. As with the other custom-render themes, `--mode debug` does not apply.
...
**`lieder`** is an engraved art-song manuscript — the quote as the vocal line of a Lied, a poem set to music. The words are split into **syllables**, one note each with lyric hyphens between them, and the clock is carried by the score's own furniture rather than by digits: the **time signature is the hour over 4** (7 o'clock → 7/4), and because a time signature genuinely governs the measure length, the hour also decides where the **barlines** fall — a 3 o'clock page is densely barred, a 12 o'clock page is wide open. The **tempo mark is the minute**: an Italian tempo word plus a metronome mark of `60 + minute` BPM, walking Larghetto → Allegro across the hour while staying in a musically plausible range at every minute.

The music tries to be real music rather than notation-shaped decoration. Each syllable's **duration comes from its stress** — phrase endings are held, stressed syllables take a quarter, weak ones an eighth — so the line has speech rhythm; bars fill to exactly the right number of beats, and the final bar is completed — the last syllable is held as long as a single notated duration allows, then padded with rests, the way an engraver finishes a measure the voice stops partway through. The **melody** is a seeded walk weighted toward stepwise motion, with four rules that give it direction: downbeats are pulled onto the tonic triad, any leap of a third or more resolves by a step in the opposite direction (the oldest rule in voice-leading, and most of what makes a line feel sung), phrase endings settle onto chord tones, and the final note **cadences onto the tonic** — a melody that ends anywhere else sounds interrupted however well-formed the rest is. Consecutive eighths are **beamed** the way modern vocal engraving beams them, breath marks sit above the staff at phrase ends, and the matched time phrase is sung in red under its own slur, biased upward so it lands as the melodic peak of its line. Ink separation is typographic before it is chromatic, the way a real engraving separates it: roman black for the plate, italic black for the editorial apparatus (tempo, expression mark, composer credit), and red for the sung phrase alone. Clef and noteheads are drawn from the bundled **Noto Music** face rather than hand-built polygons (a treble clef's spiral is exactly the shape polygon approximation turns to mush); the lyrics are **Alegreya**, a serif designed for long-form literary setting. Like the other custom-render frames it dispatches out of `render()` into its own frame function, so `--mode debug` does not apply.

**`pride`** is the Progress Pride flag, flying — and it surfaces a wider span of the palette than anything else in the rotation. Eleven bands: five are native inks (red, yellow, green, blue across the rainbow; white and black in the chevron) and the other four are recipes Idle Hours already documents — orange is the R+Y tangerine, violet the R+B, pink the R+W, light blue the B+W sky blue, brown the R+G sepia. Every ink the hardware has appears at once, and nothing new had to be invented.

The chevron order came from measuring the flag, not from memory. Two web searches returned two *different* orders — one putting white between pink and brown, the other light blue innermost — and neither matched. Reading inward from the hoist at mid-height it is **white, pink, light blue, brown, black**, with the innermost white a filled arrow rather than a band. The arms are straight, but their vertical term is scaled by the aspect ratio: the depths are fractions of *width* while an arm's travel is vertical, so a literal 45° puts the hoist corner in the wrong band on any canvas whose aspect differs from the reference's — at 800×480 it landed in light blue where the reference has brown. A test fences that order against the rendered canvas and specifically pins the pink/light-blue pair both sources got wrong. One counter-intuitive detail: the brown band looks *olive* in an RGB preview and reads as a real brown on the panel, because the panel's inks are muted — its calibrated red and green average to about #4C3B2C against the flag's #613915. Don't "correct" it from a screenshot.

The other new thing here is **shading**. Every other synthesised tone in Idle Hours mixes two inks at a constant density to fake a colour; `izakaya`'s glow was one ink at a falling density. This is the third form — tonal shading of a colour field by a low-density overlay of the two achromatic inks, so the cloth reads as lit rather than as a colour-bars test card. The bands ride a two-frequency wave and the lighting rides its *derivative*, which is why the bright band falls on the slope of each fold rather than its crest; put it on the crest and a flag reads as a corrugated roof. Each pixel resolves through a single three-way partition of an 8×8 Bayer tile rather than a stipple with an overlay painted on top, because two reads of one tile are perfectly correlated no matter how they are phased — the overlay form shifted the violet stripe to 27% red on one face of every fold and 73% on the other, a hue slide wearing the costume of shading.

The quote rests on a white card sized to its own contents, lifted off the cloth by a drop-shadow ledge, and placed in the rainbow field to the *right* of the chevron's point — a centred card would land on the arrow's tip and swallow the gesture. Type is **Jost**, the Futura-adjacent geometric sans shared with `bauhaus`, because geometric sans is the register of the 1970s poster and protest printing the flag came out of. The matched time phrase is painted in the flag's own violet, so the clock signal is drawn out of the subject rather than imposed on it. Deliberately absent: anything encoding the hour in the bands. Their count and order carry meaning that isn't a designer's to spend on a clock gimmick, so the flag is drawn as the flag and the time is carried by the matched phrase, exactly as it is in `questline`, `outrun`, `marquee` and `chrono`.

**`pulp`** is a 1940s lurid paperback front. It isn't `comic` in a different palette — `comic` is a *panel* (Ben-Day dots, racing stripes, a gutter border) and this is a *cover*: red masthead strip, huge cover title, blurb band, starburst price flash, angled corner banner. The one thing they share is the yellow ground, and even that differs — `comic` puts a red dot triangle in one corner where this lays a full-ground black screen that reads as cheap paper without shifting the hue.

The effect worth having is the **misregistration**. Pulp paperbacks were printed fast on bad presses and the giveaway is that the colour plates don't line up, so the cover title paints its red plate at an offset and drops the black plate on top, leaving a fringe on two edges. Order matters: red *after* black is a drop shadow, red *before* black is a printing fault. It's also why the theme needs a fat face — on a hairline serif the fringe eats the letterform instead of haloing it. Type is **Alfa Slab One**, picked over Ultra because it's more condensed and the corpus has long book titles. The time rides the issue line, `VOL. XII · NO. 30` — hour as a Roman volume, minute as the issue number, which is period chrome rather than a digit bolted on.

**`synoptic`** is a meteorological surface analysis, and it completes the navigation family: `firmament` is a celestial atlas, `astrarium` an instrument dashboard, `cartograph` a terrestrial chart. Where `cartograph` *describes* terrain, a synoptic chart is a field laid over geography — nested isobars, pressure centres, station plots, and front symbols.

The front symbols are the payoff, and one of them is the best argument in the whole recipe catalogue. Cold fronts are drawn blue with triangles and warm fronts red with semicircles; an **occluded** front — a cold front that has caught up with and lifted a warm one — is drawn *purple*, carrying both symbols alternately. So the red+blue mix is **semantically** right here rather than merely convenient: a real chart draws it purple precisely *because* it is the two fronts merged, which is exactly what the two inks are doing. It's the one place in the rotation a synthesised colour is used for the same reason the source material uses it. The time rides the validity stamp, `VALID 1630 LT`, since every real chart carries the observation time it analyses — labelled *local time* rather than the UTC a real analysis would carry, because the clock renders local wall time and a UTC label would be false on any appliance outside UTC.

**`vhs`** is a worn tape playing on a camcorder, and it introduces the fourth named ink technique. The first three synthesise a *colour* (constant-density two-ink mixing), a *glow* (`izakaya`'s falling density), and *shading* (`pride`'s achromatic overlay). This one synthesises a **defect**: `draw_text_chroma_shift` lays the red and blue records of the signal down at opposite horizontal offsets and covers the middle with the core, so what survives is a red fringe on one edge and a blue fringe on the other. Order is load-bearing — core first and ghosts after puts colour *over* the letterform and reads as an outline rather than as a signal coming apart. It is a cousin of `pulp`'s misregistration and worth keeping straight: there two ink *plates* miss each other in one direction, so the fringe is a printing fault; here the separation is symmetric about the glyph because a *signal* is splitting, not a sheet slipping. The matched phrase is emphasised by a wider offset rather than a different colour — on a tape, the thing that stands out is the thing that has degraded most. Over that: scanlines softer than `nightvision`'s (a terminal is scanned, tape smears), dropout flecks, tracking tears that shift bands of rows sideways *after* the text is drawn so they cut through it, and a band of head-switching static across the last few scanlines, which is the single most recognisable playback artifact. Type is **Antonio** in its first outing as a body face — a character generator draws in a tall narrow cell, and the condensed proportions are also what lets the ghosts read, since on a wide face a 2 px separation vanishes into the stem width.

This is the one theme where surfacing plain digits is authentic rather than a violation of the premise, because **a camcorder OSD is a clock** — the burn-in is the thing a viewer of such a tape actually reads the time off. The tape *date*, though, is deliberately not today's: deriving it from the clock would make the frame machine-dependent, the same trap `synoptic`'s validity stamp fell into, so it comes from a digest of the quote instead. That is also the more honest reading, since the date on a burn-in is when the tape was recorded rather than when it is being played — a different quote is a different tape.

**`cardcatalog`** is a library catalogue card, and of everything in the rotation it is the most on-brand: the one theme that is *about books being borrowed*. A manila card carries a call number, a typed author/title main entry, the quote as the card's annotation, the tracing at the foot, and a grid of date-due stamps down the right. Earlier impressions sit faded and askew with the ink density varying per stamp — a pad that dried out between borrowers — while the current one is crisp, square to the card, spans both columns, and reads `DUE` over the hour. A due *hour* rather than a due date isn't a liberty: reserve and reading-room collections ran two-hour loans and stamped exactly that. The minute stays with the matched phrase, which is painted in the same violet as the stamps, so the readable time and the stamped one are visibly the same fact recorded twice.

Two things are worth saying plainly. The panel is **exactly a card** — 800/480 reduces to 5/3, the ratio of 3×5 index stock — so the page is the card face at full bleed rather than a card drawn inside a drawer. And it is a **custom frame against its own issue's plan**: the issue proposed a literary-layout theme with a `clear_rect` knockout, but measured, the shared layout's block runs 34–766 across an 800 px page and leaves no right margin at all, and the stamp column *is* the theme. The card also invents no bibliographic data — the tracing lists a title added entry (which exists for every work), the holding collection, and the row's real Gutenberg ID as the accession number, rather than fabricating subject headings about a real book to fill the space. Type is **Special Elite**, shared with `dispatch` because real cards were typed and that is the bundle's typewriter; the objects stay distinct anyway, since one is a manila card with violet library ink and a rod punch-hole and the other a white dossier sheet with tractor-feed perforations.
**`metro`** turns the clock into a metropolitan transit diagram. Four native-ink routes cross the white map stock on strict horizontal, vertical, and 45-degree geometry, with cased strokes, station nodes, and ringed interchange markers. The quote sits in a central service-notice card; its matched time phrase becomes the red express route through Jost body type. The clock itself is transit furniture: the hour is the circular line number and the minute is the stop code. A black agency masthead and full route key complete the wayfinding system. The full-palette frame owns the canvas, so debug chrome does not apply.

**`izakaya`** is a Kabukichō back alley after rain, and the theme that introduces **glow** to the renderer. Every other synthesised tone in Idle Hours mixes two inks at a *constant* density to fake a colour the panel lacks; a bloom is the opposite — one ink at a *falling* density — so the eye integrates a gradient out of a binary field. The shared `paint_neon_mask` primitive blurs a glyph mask and reads the result back as a per-pixel Bayer density, which is what turns a hard-edged stroke into light spilling off a glass tube. The quote is bent into neon: white tube cores with a cool blue bloom for the prose, a hot yellow core with a red bloom for the matched time phrase. Vertical shop boards glow down both margins in real alley signage — 居酒屋, 焼鳥, 酒, 横丁, 喫茶, 営業中, set in the bundled Yuji Boku brush face — paper lanterns hang above, and the wet asphalt below throws every sign and lantern back as a rippled vertical smear whose distortion grows with depth. The hour rides the main lantern as a **kanji numeral** (一 … 十二), which is the one place a digit belongs without breaking the fuzzy-clock premise, since a real lantern carries a shop's character. All six inks appear at once. Distinct from `outrun`, the rotation's other neon theme, by construction: outrun is a flat poster lit uniformly, this is a *place* — light sources at different depths, each with its own bloom, over a ground that reflects them. Like the other custom-render frames it dispatches out of `render()` into its own frame function, so `--mode debug` does not apply.

**`abyssal`** is a quote read through deep water, and the theme that claims a recipe the catalogue had been holding open: `spectra6_color_recipes.md` listed **seafoam (green + blue + white)** with the note "Future ocean / spa theme" and nothing had ever used it. The surface band is that mix, painted as a 3-way Bayer partition whose weights fall with depth, so the water reads turquoise at the top and pure blue a hundred pixels down before darkening toward an abyssal floor. It fills a real palette gap too — the rotation had four blue-ish themes and none of them used blue as *depth*: `glacier` is white-ground frost, `anna_atkins` a flat Prussian-blue plate, `firmament` a navy sky, `chrono` a twilight gradient.

The upper water carries a **caustic net** — the rippling mesh of surface light, traced as a contour of an interference field rather than its peaks, because thresholding the peaks gives disconnected specks and a third incommensurate term is what breaks the regular lattice into the irregular closed cells real caustics form. Marine snow drifts through, and **bioluminescent jellyfish** glow in the dark band, lit by the same `paint_neon_mask` primitive `izakaya` introduced — this is its second consumer and the one that proves it generalises past neon, since bioluminescence is precisely a falling-density bloom. The quote takes the same cool/hot split: a blue bloom on the prose so it sits *in* the medium, a mint-green bloom on the matched phrase so the time reads as the one living light on the page.

**The hour is a depth.** A sounding gauge down the left margin runs 500 m at one o'clock to 6000 m at twelve — and 6000 m is the true floor of the abyssal zone the theme is named for, so the clock bottoms out exactly where the name does. Like the other custom-render frames it dispatches out of `render()` into its own frame function, so `--mode debug` does not apply.

**`culture`** and **`orbital`** are a pair after Iain M. Banks's Culture novels — one Orbital seen from two places — and both tell the time with the Orbital itself. An Orbital is a ring millions of kilometres across that spins once a day, so its plates cycle through dawn, noon and midnight, and at any instant the ring as a whole carries *every* local time at once. `culture` is a Mind's signal intercepted in deep space, set out the way the novels print ship-to-ship traffic (`[tight point, M16, tra. @n4.28.861.3644]`, then `x` and `o` ship names — all invented, and time-flavoured, this being a clock), with the matched phrase glowing like a drone's aura field; beside it the Orbital hangs tilted in space, its lit inner face showing land, sea and cloud, its city lights showing where it turns into dusk, and a marker riding the plate whose local time is *now* — round the lit face by day, onto the hull at night. Under it the matched phrase is written out again in a generated **Marain-idiom** script on the Culture's 3×3 dot grid (the grid is Banks's idea; the glyph table is ours, and doesn't pretend otherwise).

`orbital` stands on one of those plates and looks up. The rest of the ring rises from both horizons and meets overhead — the Arch — narrowing as it recedes, and **each part of it is lit by its own local time**: the zenith is halfway round the ring and so twelve hours away. At noon the Arch is lit at its feet and dark overhead; at midnight it blazes in daylight across a black sky. The sky follows the hour too (blue by day with the sun standing clear of the card and below the Arch at noon, a warm band on the sun's side at dawn and dusk, stars at night), and the quote card flips from white-on-sky to black with the drone-aura phrase after dark. Neither theme prints a digit of the time. Both bundle **Jura** (a humanist technical sans) and **Share Tech Mono** (OFL).
...
- Theme thumbnail grid: side-by-side previews of all seventy-three registered themes, rendered against the current quote so you can compare typography + palette before committing. Click a tile to apply it.
...
- Seventy-three themes ship built-in (full table with previews in the [Themes](#themes) section above): `default`, `dark`, `swiss`, `scholar`, `herbarium`, `newsprint`, `nightvision`, `blueprint`, `illuminated`, `gothic`, `bauhaus`, `risograph`, `comic`, `dispatch`, `atomic`, `marker`, `saloon`, `roman`, `alchemy`, `grimoire`, `deco`, `glacier`, `mucha`, `chalkboard`, `placard`, `chanbara`, `lcars`, `fillmore`, `firmament` (17th-century celestial atlas — navy synthesised ground, white Cardo serif body, gold cream matched phrase, constellation polylines + corner astronomy ornaments), `astrarium` (astronomical-clock dashboard — custom dial-plus-quote layout), `kanagawa` (Hokusai-inspired seigaiha woodblock — Yuji Boku sumi-brush body, indigo fish-scale wave pattern, hanko seal), `marquee` (1930s movie-palace facade — custom layout, alternating yellow + red bulb-light border, big Bungee Shade book-title chrome, Cardo Italic body, WRITTEN BY credit chrome), `tarot` (major-arcana card — custom layout, Roman-numeral hour + Tyrian-purple card name + hour-mapped emblem), `vinyl` (turntable + literary-audiobook LP back-cover — custom layout, pivoted tonearm as the minute indicator, Caedmon-Records-style spoken-word chrome), `vitrail` (Gothic stained-glass window — custom layout, black lead-came tracery over jewel-toned glass panes spanning the full synthesized palette, rose-window Roman numeral, quote on a clear white-glass cartouche), `cartograph` (antique cartographer's chart — IM Fell English Italic body, sepia coastlines + compass rose + sea-serpent doodle), `questline` (8-bit RPG dialogue scene — custom layout, Press Start 2P pixel face, author as the speaking NPC), `chrono` (16-bit SNES JRPG cutscene — custom layout, gradient twilight sky, shaded hourglass portrait window, Pixelify Sans), `outrun` (1980s synthwave sunset — custom layout, neon perspective grid + sliced retrowave sun, Oxanium), `circuit` (printed circuit board — forest-green soldermask, gold copper traces + plated pads, Space Mono silkscreen designators), `letter` (wax-sealed handwritten letter — Dancing Script body, dithered aged-paper plate, oxblood wax seal with a carved hourglass), `grimdark` (Warhammer-40K Imperial Gothic — dithered gunmetal bulkhead plate, gold Aquila + Mechanicus cog-skull, forge-amber matched phrase), `sampler` (counted cross-stitch sampler — custom layout, every glyph stamped as stitched X marks on Aida cloth), `anna_atkins` (1843 botanical cyanotype — Floyd–Steinberg-dithered photogram plate, copperplate Latin species labels, Libre Caslon Text), `lieder` (engraved art-song manuscript — custom layout, the quote set as lyrics under a five-line stave with one notehead per word, hour as the time signature, minute as the tempo mark, syllable-split lyrics with real rhythm and cadences), `izakaya` (neon alley at night — custom layout, the quote bent into glowing tube lettering over wet asphalt, Japanese shop signs, hour on a paper lantern), `abyssal` (deep sea — custom layout, seafoam surface fading to an abyssal floor, caustic light net, bioluminescent jellyfish, hour read as a depth), `pride` (the Progress Pride flag, flying — custom layout, eleven bands spanning every ink the panel has, tonally shaded cloth folds, quote on a card resting on the flag), `pulp` (1940s lurid paperback cover — custom layout, off-register colour plates, hour as a Roman volume and minute as the issue number), `synoptic` (meteorological surface analysis — isobars, station plots, and cold / warm / occluded front symbols with the occluded in its semantically-correct R+B purple), `vhs` (worn tape under a camcorder OSD — custom layout, chroma-bled text, tracking tears, wall-clock burn-in), `bakelite` (mid-century instrument console — custom layout, amber-phosphor glow on a brown scanline CRT set in a warm sand moulding, hour as a setting index), `cardcatalog` (library catalogue card — custom layout, hour stamped on the freshest date-due impression), `metro` (metropolitan transit diagram — custom layout, four native-ink routes on strict horizontal / vertical / 45-degree geometry, hour as the line number and minute as the stop code), `intaglio` (banknote engraving — custom layout, tone rendered as line-work: guilloché rosettes, a hatched cartouche, the hour spelled as the note's denomination), `nocturne` (Whistler's Nocturne in Blue and Gold — custom layout, flow-field brushwork sky and water, gold shore lights and falling-rocket sparks, butterfly monogram), `plaque` (patinated bronze memorial plaque — custom layout, relief-lit raised brass lettering on a dark verdigris-bronze ground, hour as the ERECTED year's Roman numeral), `daguerreotype` (cased 1850s photograph — custom layout, Atkinson-dithered monochrome plate in a brass mat with a pewter rim and sepia tarnish, quote on the caption slip), `autochrome` (1907 Autochrome Lumière colour plate — custom layout, the first plate dithered against all six inks, in a black passe-partout binding tape with the quote on a cream mount card), `photo` (the operator's own photograph or a directory of them via `--photo-path` — conditioned only as far as a six-ink dither needs, with the quote card placed over whichever region of the picture holds the least detail), `betweenus` / `betweenus_dark` (the Between Us app's card UI, light and dark — warm-paper ground, soft-shadowed rounded quote card, Fraunces body with the time phrase in italic terracotta, the app's five-tier legend, and a day-progress bar as the only time carrier), `carcosa` (The King in Yellow — black night over Lake Hali, tattered yellow curtains drawn back, an original Yellow Sign, black stars, and the towers of Carcosa against twin setting suns, Almendra body), `control` (Remedy's *Control* — custom layout, the Astral Plane: isometric stone blocks floating in a white void, the Board's inverted pyramid, a concrete plinth carrying a Federal Bureau of Control sign, and the matched phrase in Hiss red bleeding a coral halo into the white), `observation` (No Code's *Observation* — custom layout, S.A.M.'s camera feed: a banded Saturn with its blue polar cap, hexagonal jet stream and lit rings, a glowing hexagonal anomaly under a yellow tracking reticle, and the quote as an audio-log transcript in IBM Plex Mono with the matched phrase yellow in a tangerine halo; the hour is the camera number), `trisolaris` (Liu Cixin's *The Three-Body Problem* — custom layout, three suns and a planet from a live gravitational integration the clock advances, stable and chaotic eras read off the physics, civilizations numbered as they are destroyed, the Red Coast dish transmitting from Radar Peak), `biomech` (H. R. Giger + Zdzisław Beksiński — a K+W airbrushed biomechanical wall, lit as a procedural height field, framing a pointed arch onto a dithered blood-red dusk and a ruined cathedral; bone-white Spectral with an ember matched phrase, the hour the sill plate's Roman numeral), `codex` (the Codex Seraphinianus — custom layout, a page of Luigi Serafini's imaginary encyclopedia: a chimerical plant plate in full-palette colour, columns of procedurally generated asemic script, the quote as the page's one deciphered passage in a Fondamento pen hand, and the time as a base-21 page number in invented numerals), `culture` (Iain M. Banks's Culture — custom layout, a Mind's signal in deep space with the matched phrase in a drone-aura bloom, beside a tilted Orbital whose marked plate keeps the local time of day, and the phrase again in Marain-idiom glyphs), `orbital` (the Culture's Arch seen from an Orbital's plate — custom layout, the far side of the ring lit plate by plate by each plate's own local time, so the Arch is a 24-hour dial; the sky, sun and quote card follow the hour), `furies` (Francis Bacon's 1944 *Three Studies for Figures at the Base of a Crucifixion* — custom layout, the triptych under glass in gilt frames on a black gallery wall: a hunched figure on a table, a bandaged figure on a pedestal opening into teeth, a screaming head on stalk legs in a tuft of grass, all smeared across flat cadmium orange; the quote as white Libre Franklin wall text with the matched phrase in the painting's orange and a red smear dragged off it), `bosch` (Hieronymus Bosch's *Garden of Earthly Delights* — custom layout, the triptych open with Paradise, the Garden and Hell, the quote lettered on a phylactery banderole in Grenze Gotisch with the matched phrase rubricated red, and the whole altarpiece crazed with procedural craquelure), `diags` (calibration / status panel — excluded from `--theme random`). Every theme colour stays on the Spectra 6 palette.
