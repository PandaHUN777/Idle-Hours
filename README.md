...
- Theme thumbnail grid: side-by-side previews of all sixty-four registered themes, rendered against the current quote so you can compare typography + palette before committing. Click a tile to apply it.
